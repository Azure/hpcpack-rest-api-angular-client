...
export class DefaultService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createNodeGroup(x_ms_as_user?: string, nodeGroup?: NodeGroup, observe?: 'body', reportProgress?: boolean): Observable<NodeGroup>;
    public createNodeGroup(x_ms_as_user?: string, nodeGroup?: NodeGroup, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<NodeGroup>>;
    public createNodeGroup(x_ms_as_user?: string, nodeGroup?: NodeGroup, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<NodeGroup>>;
    public createNodeGroup(x_ms_as_user?: string, nodeGroup?: NodeGroup, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<NodeGroup>(`${this.basePath}/cluster/nodeGroups`,
            nodeGroup,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public deleteNodeGroup(name: string, x_ms_as_user?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/cluster/nodeGroups/${encodeURIComponent(String(name))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getClusterNodeMetrics(metricNames: string, observe?: 'body', reportProgress?: boolean): Observable<Array<NodeMetric>>;
    public getClusterNodeMetrics(metricNames: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<NodeMetric>>>;
    public getClusterNodeMetrics(metricNames: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<NodeMetric>>>;
    public getClusterNodeMetrics(metricNames: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (metricNames === null || metricNames === undefined) {
            throw new Error('Required parameter metricNames was null or undefined when calling getClusterNodeMetrics.');
        }
        ...
        return this.httpClient.get<Array<NodeMetric>>(`${this.basePath}/cluster/nodes/metrics`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getClusterOperation(id: string, x_ms_as_user?: string, observe?: 'body', reportProgress?: boolean): Observable<OperationLog>;
    public getClusterOperation(id: string, x_ms_as_user?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<OperationLog>>;
    public getClusterOperation(id: string, x_ms_as_user?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<OperationLog>>;
    public getClusterOperation(id: string, x_ms_as_user?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getClusterOperation.');
        }
        ...
        return this.httpClient.get<OperationLog>(`${this.basePath}/cluster/operations/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getNodeGroup(name: string, x_ms_as_user?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<NodeGroup>(`${this.basePath}/cluster/nodeGroups/${encodeURIComponent(String(name))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getNodeGroups(x_ms_as_user?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<NodeGroup>>;
    public getNodeGroups(x_ms_as_user?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<NodeGroup>>>;
    public getNodeGroups(x_ms_as_user?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<NodeGroup>>>;
    public getNodeGroups(x_ms_as_user?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<NodeGroup>>(`${this.basePath}/cluster/nodeGroups`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getNodesOfGroup(name: string, x_ms_as_user?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<string>>(`${this.basePath}/cluster/nodeGroups/${encodeURIComponent(String(name))}/nodes`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public moveNodesOfGroup(name: string, x_ms_as_user?: string, operation?: NodeGroupOperation, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.patch<Array<string>>(`${this.basePath}/cluster/nodeGroups/${encodeURIComponent(String(name))}/nodes`,
            operation,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public updateNodeGroup(name: string, x_ms_as_user?: string, nodeGroup?: NodeGroup, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<NodeGroup>(`${this.basePath}/cluster/nodeGroups/${encodeURIComponent(String(name))}`,
            nodeGroup,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
